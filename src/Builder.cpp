...
Builder::Builder()
{
    ...
    _builders["4801"] = &Builder::createC4801;
    _builders["4008"] = &Builder::createC4008;
}
...
uComp Builder::createC4008(std::string const &name)
{
...
uComp Builder::createC4801(std::string const &name)
{
