...
void C4801::fillMemory()
{
    ...
    address[9] = _pins[22];
    std::bitset<8> data;
    data[0] = compute(9) == nts::TRUE ? 1 : 0;
    data[1] = compute(10) == nts::TRUE ? 1 : 0;
    data[2] = compute(11) == nts::TRUE ? 1 : 0;
    data[3] = compute(13) == nts::TRUE ? 1 : 0;
    data[4] = compute(14) == nts::TRUE ? 1 : 0;
    data[5] = compute(15) == nts::TRUE ? 1 : 0;
    data[6] = compute(16) == nts::TRUE ? 1 : 0;
    data[7] = compute(17) == nts::TRUE ? 1 : 0;
